package ru.mixail_akulov.a38_jetpacknavcom3.screens.main
...
import ru.mixail_akulov.a38_jetpacknavcom3.databinding.ActivityMainBinding
import ru.mixail_akulov.a38_jetpacknavcom3.screens.main.tabs.TabsFragment
...
class MainActivity : AppCompatActivity() {
    ...
    private fun prepareTitle(label: CharSequence?, arguments: Bundle?): String {
        ...
        // код для этого метода был скопирован из источников Google:)
    ...
    private fun isSignedIn(): Boolean {
        // берем из активити bundle с аргументами, и если он == null бросаем исключение
